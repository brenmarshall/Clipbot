...
public class RobotCentricTank extends LinearOpMode {
    ...
    public static double medium = 11.0;
    public static double high = 21.0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            double command = control.update(targetPosition, liftMotorLeft.getCurrentPosition());
            command = Range.clip(command, -1, 1);
            // Assign PID output
            double motorPosition = liftMotorLeft.getCurrentPosition();
            ...
            liftMotorLeft.setPower(command);
