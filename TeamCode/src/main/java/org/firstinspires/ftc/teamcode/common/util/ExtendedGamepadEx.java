...
import org.firstinspires.ftc.teamcode.common.util.ExtendedGamepadKeys.Button;
 ...
 */
public class ExtendedGamepadEx extends GamepadEx {
    ...
    private HashMap<Button, ExtendedButtonReader> buttonReaders;
    private HashMap<Button, ExtendedGamepadButton> gamepadButtons;
     ...
     */
    public ExtendedGamepadEx(Gamepad gamepad) {
        super(gamepad);
        this.gamepad = gamepad;
        buttonReaders = new HashMap<>();
        gamepadButtons = new HashMap<>();
        for (Button button : buttons) {
            buttonReaders.put(button, new ExtendedButtonReader(this, button));
            gamepadButtons.put(button, new ExtendedGamepadButton(this, button));
        }
    }
     ...
     */
    public ExtendedGamepadButton getGamepadButton(Button button) {
