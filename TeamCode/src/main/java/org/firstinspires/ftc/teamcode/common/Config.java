...
public class Config {
    ...
    public static double clipperDrive_kP = 0.01, clipperDrive_kI = 0.0, clipperDrive_kD = 0.0, clipperDrive_kF = 0.0, clipperDrive_tolerance = 10.0, clipperDrive_ticksPerCM = 0.0;
