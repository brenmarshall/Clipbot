...
public class AutoLv3AscentCommand extends SequentialCommandGroup {

    public AutoLv3AscentCommand(Bot bot) {
        addCommands(
                new ConditionalCommand(
                        new ParallelCommandGroup(
                                new SetDriveCommand(bot, false),
                                //new SetPTOPositionCommand(bot.getAscent(), Ascent.PTOState.ENGAGED),
                                //new SetDepositSlidesPositionCommand(bot.getDeposit(), 0.0),
                                new WaitCommand(250),
                                //new SetDepositSlidesPositionCommand(bot.getDeposit(), Configuration.Lv3LiftHeight),
                                new WaitCommand(250),
                                //new SetDepositSlidesPositionCommand(bot.getDeposit(), 0.0)
                                new WaitCommand(250)
