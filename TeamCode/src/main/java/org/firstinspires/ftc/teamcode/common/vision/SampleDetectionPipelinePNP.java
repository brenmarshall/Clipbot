...
public class SampleDetectionPipelinePNP extends OpenCvPipeline {
    ...
    public SampleDetectionPipelinePNP() {
        ...
        double fx = 538.3126346639108; // Replace with your camera's focal length in pixels
        double fy = 535.4959552950476;
        double cx = 315.107464846287; // Replace with your camera's principal point x-coordinate (usually image width / 2)
        double cy = 247.99095692788904; // Replace with your camera's principal point y-coordinate (usually image height / 2)
        ...
        distCoeffs = new MatOfDouble(-0.6053273103472906, 0.5373094159180536, -0.0035569270422075674, 0.006623888464405801, -0.2597600665980877);
    }
